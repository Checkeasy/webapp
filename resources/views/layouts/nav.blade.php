    ...
    <!-- <div class="container"> -->
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a style="margin-right: 3px;" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{ Name } <span class="glyphicon glyphicon-user"></span></a>
